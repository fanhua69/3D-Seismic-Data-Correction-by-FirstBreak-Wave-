...
CProDlg::CProDlg(UINT nCaptionID)
{
    m_bCancel=FALSE;
    m_nLower=0;
    m_nUpper=100;
...
BOOL CProDlg::Create(CWnd *pParent)
{
    ...
    if(!CDialog::Create(CProDlg::IDD,pParent))
    {
      ReEnableParent();
      return FALSE;
    }
...
void CProDlg::SetStatus(LPCTSTR lpszMessage)
{
...
void CProDlg::OnCancel()
{
    m_bCancel=TRUE;
}

void CProDlg::SetRange(int nLower,int nUpper)
{
    m_nLower = nLower;
    m_nUpper = nUpper;
...
BOOL CProDlg::CheckCancelButton()
{
...
void CProDlg::UpdatePercent(int nNewPos)
{
...
BOOL CProDlg::OnInitDialog() 
{
	...
	CString strCaption("In Progress...");
